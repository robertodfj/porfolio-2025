export default function Contact() {
  return (
    <section id="contacto" className="bg-gray-50 text-gray-600 body-font relative py-16">
      {/* Título con línea */}
      <div className="text-center mb-12">
        <h2 className="text-3xl font-semibold text-gray-900 mb-2">Contacto</h2>
      ...
      <div className="p-2 w-full text-center">
        <a
          className="inline-flex items-center justify-center mx-auto text-white bg-indigo-500 border-0 py-3 px-10 rounded-lg text-lg font-medium shadow-md transition hover:bg-indigo-600 hover:shadow-lg"
      ...
      {/* Info + Redes */}
      <div className="p-2 w-full pt-10 mt-10 border-t border-gray-200 text-center">
        <a
          href="mailto:robertodfj93@gmail.com"
          className="text-indigo-500 text-lg font-medium hover:underline"
        >
          robertodfj93@gmail.com
        </a>
        <p className="leading-relaxed my-4 text-gray-700">
        ...
        <div className="flex justify-center gap-6 mt-4">
          ...
          {/* Email */}
          <a
            href="mailto:robertodfj@gmail.com"
            aria-label="Correo"
        ...
        <p className="text-sm text-gray-500 mt-8">
          © 2025 Roberto de Frutos Jimenez. Todos los derechos reservados.
        </p>
      </div>
    </section>
  );
